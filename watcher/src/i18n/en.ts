export const en = {
  ...
  // Watch flow: `/start w_<chainId>_<addr>` from the web app's Watch CTA.
  // One-off classification peek; no subscription is created. Nudges the
  // user back to the web app for persistent alerts.
  'watch.reply':
    'Current status for {eoa} on {chain}:\n{target}\nClassification: {classification}\n\nWant alerts every time this address is re-delegated? Paste it on https://setcode.watch and tap Subscribe.',
